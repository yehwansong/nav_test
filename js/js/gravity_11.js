...
var obs = []
    ...
    // red
        ...
        ['rec', 1,   4, 6.4,    1,          2, 0],
        ['rec', 1,  10,   4,    5.5,        2, 0],
        ['rec', 10.5, 8.2,      1.8, 1.5,   2, 0],
        ['rec', 14,      7,     1.2, 2.5,   2, 0],
        ...
        ['cir', 2,     10,   2,   0, 5],
        ['svg',5,  10, skew_cir ,   14, 5],
        ['svg',7,  10, skew_cir ,   14, 5 , 'rot'],
    ]
        ...
        for (var i = 0; i < chain_wrap[k].length ; i++) {
            ...
            if(i == chain_wrap[k].length-1){
                ...
                for (var j = chain_array.length - 1; j >= 0; j--) {
                    adding_obj(chain_array[j],0)
                }
                for (var j = constraint_array.length - 1; j >= 0; j--) {
                    adding_obj(constraint_array[j],0)
                }
            }
        }
        ...
        for (var i = 0; i < chain_3.length ; i++) {
            ...
            if(i == chain_3.length-1){
                ...
                for (var j = chain_array_3.length - 1; j >= 0; j--) {
                    adding_obj(chain_array_3[j],5)
                }
                for (var j = constraint_array_3.length - 1; j >= 0; j--) {
                    adding_obj(constraint_array_3[j],5)
                }
            }
        }
}
//extra
    ...
    World.add(world, [color_b, color_w, ground, wall1, wall2])
...
function detectcollision_in(){
    ...
    setTimeout(function(){reset_field()}, 25000);
